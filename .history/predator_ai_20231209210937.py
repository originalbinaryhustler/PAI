...
▒█▄▄░▀▄▀░▀▄▄░█▀█▒█▄▄▒░░█░█▀▒░▀▄▀░██▒░░▀▄▄▒█▒█░█▀█░█▒▀█░▀▄█░█▄▄░█▀▄
        ...
        ''')
   print_clr("This function will help you change the IPv6 Link-Local address manually.", 'yellow')
   print_clr("This can be useful for enhancing privacy and security.", 'yellow')
   print_clr("However, it may cause issues with network compatibility and performance.", 'yellow')
...
options = {
     "System" : None,
     "-A = Auto starts on selection":None,
