...
async def sport():
    ...
    print(f'port scanning IP {IP} and port ranges ({r1} , {r2}). ')

    print(f'Scanning ports {r1} to {r2} this may take a moment...')
    q = queue.Queue()
    ...
    print(f'port scanning IP {IP} and port ranges ({r1} , {r2}) complete. ')
