...
def extract(proxy):
 ...
 try:
    ...
    printb(r.json(), str(r.status_code)+ '\n')
 except requests.ConnectionError as err:
    pass
...
▒█▄▄░▀▄▀░▀▄▄░█▀█▒█▄▄▒░░█░█▀▒░▀▄▀░██▒░░▀▄▄▒█▒█░█▀█░█▒▀█░▀▄█░█▄▄░█▀▄
        ...
        ''')
   printb("This function will help you change the IPv6 Link-Local address manually.")
   printb("This can be useful for enhancing privacy and security.")
   printb("However, it may cause issues with network compatibility and performance.")
